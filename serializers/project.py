...
from maintainer_site.serializers.project_maintainer import ProjectMaintainerListSerializer
...
class ProjectDetailSerializer(serializers.ModelSerializer):
    ...
    project_maintainers = ProjectMaintainerListSerializer(many=True, read_only=True)
